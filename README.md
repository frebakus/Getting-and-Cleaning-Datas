...
Merging Datasets
Create testData set from subject_test.txt, X_test.txt, y_test.txt after applying the column names from features.txt Create trainData set from subject_train.txt, X_train.txt, y_train.txt after applying the column names from features.txt
